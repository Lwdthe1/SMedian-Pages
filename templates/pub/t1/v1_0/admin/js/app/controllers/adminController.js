...
angularApp
    ...
    function prepareDraftData(page, pub) {
        ...
        function ensureArrayFieldNotEmpty(obj, field, firstValue) {
            ...
            if(!obj[field].length) obj[field].push(firstValue)
        }
        ...
        ensureField(draftData.heroSection, 'backgroundImageUrl', '/vendor_node/smedian-pages/templates/pub/t1/page/images/thought-catalog-214785-min.jpg')
